...
export const LOAD_CURRIO_BY_ID = '[Currio Page] Load Currio By Id'; // Se non caricato con la lista
...
export const LOAD_CURRIO_SUBMISSIONS = '[Events Page] load currio submissions'; // Mantieni o adatta nome
export const LOAD_CURRIO_SUBMISSIONS_SUCCESS = '[Events Page] load currio submissions success'; // Mantieni o adatta nome
...
export const createCurrio = createAction(CREATE_CURRIO, props<{ currio: Omit<Currio, 'id'> }>()); // Ometti l'ID per la creazione
export const createCurrioSuccess = createAction(CREATE_CURRIO_SUCCESS, props<{ currio: Currio }>()); // Firebase restituirà l'oggetto con ID
...
export const updateCurrioSuccess = createAction(UPDATE_CURRIO_SUCCESS, props<{ currio: {id: string, changes: Partial<Currio>} }>()); // Per NgRx Entity o aggiornamento parziale
...
// Implementazioni Azioni Currio Submissions (verifica e adatta nomi se necessario)
